    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            */
            ...
            /*
                This sample uses Reverse to create a list of all digits in the array whose second letter 
                is 'i' that is reversed from the order in the original array.
            */
            orderingOperators.RevereDigitsWhoseSecondLetterIsILinq(DataProvider.GivenDigits());
            orderingOperators.RevereDigitsWhoseSecondLetterIsILambda(DataProvider.GivenDigits());
        }
    }
}
